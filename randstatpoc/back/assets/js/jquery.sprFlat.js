...
// by administrateur www.suggeelson.com
    ...
    $.sprFlat = function(element, options) {
        ...
        plugin.chatWindow = function() {
            ...
            function appendMsg (msg) {
                $('.chat-box .chat-messages').append('<li class="chat-me"><p class="avatar"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/roybarberuk/randstadicon.png" alt="administrateur"></p><p class="chat-name">administrateur <span class="chat-time">Now</span></p><p class="chat-txt">'+ msg +'</p></li>');
            }
        }
        ...
        plugin.breadCrumbs = function () {
            ...
            //empty curmb
            breadcrumb.empty();
            breadcrumb.append('<li>'+homeIcon+'<a href="index.html">Accueil </a>'+rightArrow+'</li>');
